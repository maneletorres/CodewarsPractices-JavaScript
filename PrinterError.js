 ...
 * of boxes the printer has to use colors which, for the sake 
 ...
 * 
 * You have to write a function printer_error which given a s
 * tring will output the error rate of the printer as a string 
 * representing a rational whose numerator is the number of
 *  errors and the denominator the length of the control string. 
